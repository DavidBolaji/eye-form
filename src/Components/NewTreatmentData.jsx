      ...
      >
        {({ isSubmitting, values }) => (
          <Form className="space-y-4">
            <div
              id="hhh"
              className="flex gap-2 justify-between flex-row-reverse max-h-screen overflow-y-scroll"
            >
              <div className="w-1/2">
                  ...
                  <>
                    <div className="flex flex-col">
                      <label htmlFor="number" className="mb-2 font-bold">
                        Was Treatment added after SLT left
                      </label>
                      <Field
                        as={'select'}
                        type="text"
              ...
              <div className="w-1/2">
                {(values.whatEye === 'right' || values.whatEye === 'both') && (
                  <>
                    <div className="flex flex-col">
                      <label htmlFor="number" className="mb-2 font-bold">
                        Was Treatment added after SLT right
                      </label>
                      <Field
                        as={'select'}
                        type="text"
